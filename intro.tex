...
% Nanostructure
\change{In applications in thermionic \cite{zeng06}\cite{westover08} and thermophotonic \cite{oksanen08} cooling, good thermal insulation between materials separated by nanoscale gap is required. Nanoscale point contacts bridging the vacuum gap between materials are a good alternative due to their good structural support and small thermal conductance \cite{bartsch12}. In such small structures, the wave nature of phonons cannot be neglected and interference effects appear. While the thermal conductance of point contacts has been theoretically studied in earlier works \cite{jeong12}, there have been no investigations of interference effects. Recognizing interference effects in point contacts could enable thermal conductivity engineering in a similar way as, e.g., in silicon thin films with local resonators \cite{davis14}.}
