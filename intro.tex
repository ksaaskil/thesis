...
\change{The number density of transistors in a microchip has increased exponentially for more than four decades, powering the digital revolution. The increase in transistor density and operating frequency have lead to an exponential increase in the dissipated power density as well, increasing the power consumption and requiring drastic cooling solutions \cite{pop10}. While the increase in dissipated power has slowed down by the introduction of multi-core CPUs, proper management of the unwanted heat at both chip and individual transistor level is still an essential ingredient of modern electronics design \cite{pop06_ieee}.}
