...
\change{The density of transistors in state-of-the-art microchips has increased exponentially for more than four decades, powering the digital revolution. The increase in transistor density and operating frequency have lead to an exponential increase in the dissipated power density as well, increasing the power consumption of CPUs and requiring drastic cooling  solutions in datacenters \cite{pop10}. While the increase in dissipated power has slowed down by the introduction of multi-core CPUs, proper management of the unwanted heat at both chip and individual transistor level is still a key ingredient of modern electronics design \cite{pop06_ieee}.}
