...
% Progress, advances in manufacturing/synthesis/processing/ 
% Controlling the flow of heat
% Applications in more efficient TC converters, mitigating heating in digital electronics, new applications in phase-change memory, heat-assisted magnetic recording
