...
\change{Heat transfer is customarily described theoretically either by monitoring the energy exchanged between individual atoms or molecules or by treating the heat carriers as a gas of particles flowing from hot to cold. While the particle picture is highly useful for, e.g., structures too large for atomic scale treatment, the structures considered in this thesis require atomic scale modeling starting from the microscopic equations of motion and capturing, e.g., the wave nature of phonons.}
